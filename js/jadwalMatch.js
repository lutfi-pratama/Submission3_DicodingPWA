      ...
      JadwalHTML += `
          ...
          <div class="card">
            <div class="card-content">
              <div center-align>
                <h5 class="center-align day-jadwal">Matchday : ${match.matchday}</h5>
                <div class="center-align">Kick Off : ${convertDate(new Date(match.utcDate))}</div>
          
                <div class="row" style="margin:20px">
                  <div class="col s5 truncate right-align">
                    <span class="team-jadwal">  ${match.homeTeam.name}</span>
                  </div>
                  <div class="col s2 ">
                    VS
                  </div>
                  <div class="col s5 truncate left-align">
                    <span class="team-jadwal">  ${match.awayTeam.name}</span>
                  </div>
                </div>
              </div>
            </div>
